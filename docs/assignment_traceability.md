...
| Trained model/weights | committed selected checkpoints + SHA-256/model cards | DETECTOR COMPLETE; SEGMENTATION PENDING |
...
| Actual hardware/runtime/memory | benchmark JSON with hardware fingerprint | DETECTOR CPU LATENCY COMPLETE; FULL PIPELINE PENDING |
